...
private void input(){
	...
	System.out.print("Entre no. of processes:");
	np = sc.nextInt();//no.of process
	System.out.print("Entre no. of resources:");
	...
	for(int i=0;i<np;i++){
	   System.out.print("Entre allocation matrix for process P"+i+":");
	   for(int j=0;j<nr;j++)
	...
	System.out.print("Enter availible matrix for process P0: ");
	for(int j=0;j<nr;j++)
	  avail[0][j] = sc.nextInt();//availible matrix
